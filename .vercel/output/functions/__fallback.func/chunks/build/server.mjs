...
import { c as createError$1, n as hasProtocol, o as isScriptProtocol, l as joinURL, w as withQuery, p as sanitizeStatusCode, q as getContext, $ as $fetch, t as createHooks, v as executeAsync, x as toRouteMatcher, y as createRouter$1, z as defu } from '../nitro/nitro.mjs';
...
const _routes = [
  ...
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DpeBYerC.mjs')
  },
  {
    name: "test-isr",
    path: "/test-isr",
    component: () => import('./test-isr-rx0R8iTX.mjs')
  },
  {
    name: "test-ssg",
    path: "/test-ssg",
  ...
  },
  {
    name: "test-ssr",
    path: "/test-ssr",
    component: () => import('./test-ssr-C_XPSf5R.mjs')
  },
  {
    name: "posts-id",
    path: "/posts/:id()",
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-o2QH8cov.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BsYCvBBf.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DznR3jCL.mjs'));
...
export { _export_sfc as _, asyncDataDefaults as a, useRouter as b, createError as c, useRuntimeConfig as d, entry$1 as default, nuxtLinkDefaults as e, fetchDefaults as f, navigateTo as n, resolveRouteObject as r, useNuxtApp as u };
